...
Funcion detalles_habilidades (pikmin,nombres_pikmin,elemento,esp_atq,atq,def,esp_def,rapidez,habilidades_aliado_name,dmg_aliado,elemento_habilidad,precision_habilidad,objetivo)
	...
	FinPara
	escribir " |     Daño: " Sin Saltar
	si dmg_aliado[2] >= 0 y dmg_aliado[2] <= 9 Entonces
		escribir dmg_aliado[2] " DPH     |     " Sin Saltar
	sino si dmg_aliado[2] >= 10 y dmg_aliado[2] <= 99 Entonces
			escribir dmg_aliado[2] " DPH    |     " Sin Saltar	
		FinSi
	FinSi
	Escribir "Precision: " Sin Saltar
	...
	FinPara
	escribir " |     Daño: " Sin Saltar
	si dmg_aliado[3] >= 0 y dmg_aliado[3] <= 9 Entonces
		escribir dmg_aliado[3] " DPH     |     " Sin Saltar
	sino si dmg_aliado[3] >= 10 y dmg_aliado[3] <= 99 Entonces
			escribir dmg_aliado[3] " DPH    |     " Sin Saltar	
		FinSi
	FinSi
	Escribir "Precision: " Sin Saltar
	...
	FinPara
	escribir " |     Daño: " Sin Saltar
	si dmg_aliado[4] >= 0 y dmg_aliado[4] <= 9 Entonces
		escribir dmg_aliado[4] " DPH     |     " Sin Saltar
	sino si dmg_aliado[4] >= 10 y dmg_aliado[4] <= 99 Entonces
			escribir dmg_aliado[4] " DPH    |     " Sin Saltar	
		FinSi
	FinSi
	Escribir "Precision: " Sin Saltar
...
Funcion objeto = mochila (consumibles)
	...
	Escribir "x                                                                               x                                                               x"
	Escribir "x     1. Pocion chica:  " consumibles[1]    " Disponibles                                           x      1. Te cura 30 puntos de vida                             x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     2. Pocion mediana:  " consumibles[2]      " Disponibles                                         x      2. Te cura 60 puntos de vida                             x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     3. Pocion grande:  " consumibles[3]     " Disponibles                                          x      3. Te cura toda la vida                                  x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     4. Energia chica:  " consumibles[4]       " Disponibles                                          x      4. Te da 15 puntos de energia	                            x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     5. Energia grande:  " consumibles[5]        " Disponibles                                         x      5. Te da 30 puntos de energia                            x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x                                                                               x                                                               x"
...
Funcion combate(enemigo,pikmin,pikmin_2,hp_1,hp_2,hp_3,ene_1,ene_2,nom_enemigo,nom_pikmin,nom_pikmin2,consumibles,nom_consumibles,tipo_interfaz)
	...
	Dimension dmg_aliado[4],dmg_enemigo[4],habilidades_aliado_name[4],habilidades_enemigo_name[4],elemento_habilidad[4],elemento_habilidad_enemigo[4],precision_habilidad[4],precision_habilidad_enemigo[4],objetivo[4]
			...
			Segun turno Hacer
				...
				0:
					si hp_2 >= 1 Entonces
						...
						Escribir "xx                                                                                                                                             xx"
						Escribir "xx                                                                                                                                             xx"
						Escribir "xx       Ha usado ataque destructo de mundos                                                                                                   xx"
						Escribir "xx                                                                                                                                             xx"
						Escribir "xx                                                                                                                                             xx"
						Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
						Esperar 2 Segundos
				...
				1:
					...
					segun accion Hacer
									...
									segun ataque Hacer
										...
										1,2,3,4:
											...
											si evasion == 1 Entonces
												Segun ataque Hacer
													1:
														hab_usada(pikmin,enemigo,hp_1,hp_2,ene_1,ene_2,habilidades_aliado_name[ataque])
														Borrar Pantalla
														animacion_victima(enemigo,hp_1,hp_2,ene_1,ene_2)
														animacion_atacante(pikmin,hp_1,hp_2,ene_1,ene_2)
														Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
						...
						2:// MOCHILA
							...
							FinSi
						3:// info
							detalles_habilidades(pikmin,nom_pikmin,elemento[pikmin],esp_atq[pikmin],atq[pikmin],def[pikmin],esp_def[pikmin],rapidez[pikmin],habilidades_aliado_name,dmg_aliado,elemento_habilidad,precision_habilidad,objetivo)
							Esperar tecla
							a = a - 1
							turno = 3
							comprobacion = 1
...
Algoritmo pruebas
	...
	ene_1 = 50 ; ene_2 = 50
	consumibles[1] = 5
	nom_consumibles[1] = "Pocion de vida chica"
	consumibles[2] = 1
	nom_consumibles[2] = "Pocion de vida mediana"
	consumibles[3] = 1
	nom_consumibles[3] = "Pocion de vida grande"
	consumibles[4] = 5
	nom_consumibles[4] = "Pocion de energia chica"
	consumibles[5] = 1
	nom_consumibles[5] = "Pocion de energia grande"
...
//	//pre_combate(enemigo, pikmin,nombres_pikmin[enemigo],nombres_pikmin[pikmin],hp_1,hp_2,ene_1,ene_2) // Animacion inicial
	combate(enemigo,pikmin,pikmin_2,hp_1,hp_2,hp_3,ene_1,ene_2,nombres_pikmin[enemigo],nombres_pikmin[pikmin],nombres_pikmin[pikmin_2],consumibles,nom_consumibles,2) //Combate en bucle
FinAlgoritmo
