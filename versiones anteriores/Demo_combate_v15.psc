Funcion objeto = mochila (pocion_vida_chica Por Referencia,pocion_vida_mediana Por Referencia,pocion_vida_grande Por Referencia,antidoto Por Referencia,proteccion Por Referencia)
	Borrar Pantalla
	...
	Escribir "x                                                                               x                                                               x"
	Escribir "x     OBJETOS:                                                                  x                                                               x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     1. Pocion chica:  " pocion_vida_chica "                                                       x       - Te cura 30 puntos de vida                             x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     2. pocion mediana:  " pocion_vida_mediana "                                                     x       - Te cura 60 puntos de vida                             x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     3. pocion grande:  " pocion_vida_grande "                                                      x       - Te cura toda la vida                                  x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     4. antidoto:  " antidoto "                                                           x       - Te saca todo efecto negativo	                          x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x     5. proteccion:  " proteccion "                                                         x       - Aumenta la proteccion por 2 turnos                    x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x                                                                               x                                                               x"
	Escribir "x                                                                               x                                                               x"
...
Funcion accion = interfaz_principal (pikmin,enemigo,hp_1,hp_2,ene_1,ene_2)
	...
	Escribir "xx       Que haras?                                                                                  xx                                        xx"
	Escribir "xx                                                                                                   xx       3. Pikmin                        xx"
	Escribir "xx                                                                                                   xx                                        xx"
	Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
	leer accion
FinFuncion
	...
	para a = 1 Hasta 6 Hacer
		segun a Hacer
			1:
				...
				Escribir "x           oooooooooooooooooooooooooooooooooooooooooooo                                                                                        x"
				Escribir "x           ll  ???                                   ll                                                                                        x"
				Escribir "x           ll                      HP: 100/100       ll                                                                                        x"
				Escribir "x           ll  ENERGIA: 50/50                        ll                                                                                        x"
				Escribir "x           oooooooooooooooooooooooooooooooooooooooooooo                                                                                        x"
				Escribir "x                                                                                                                                               x"
				Escribir "x                                                                                                                                               x"
				Escribir "x                                                                                                                                               x"
			...
			2:
				...
				Escribir "x           ll                      HP: 100/100       ll                                               x     x                                  x"
				Escribir "x           ll  ENERGIA: 50/50                        ll                                              x---O---x                                 x"
		...
		segun a Hacer
			5:
				...
				Escribir "x                  x---O---x                                                                xx                      HP: 100/100       xx        x"
				Escribir "x                   x     x                                                                 xx  ENERGIA: 50/50                        xx        x"
				Escribir "x                     x x                                                                   oooooooooooooooooooooooooooooooooooooooooooo        x"
				Escribir "x                                                                                                                                               x"
			6:
				interfaz_pikmin(pikmin,hp_1,hp_2,ene_1,ene_2)
			De Otro Modo:
				...
				Escribir "x                                                                                           oooooooooooooooooooooooooooooooooooooooooooo        x"
				Escribir "x                                                                                           xx  ???                                   xx        x"
				Escribir "x                                                                                           xx                      HP: 100/100       xx        x"
				Escribir "x                                                                                           xx  ENERGIA: 50/50                        xx        x"
				Escribir "x                                                                                           oooooooooooooooooooooooooooooooooooooooooooo        x"
				Escribir "x                                                                                                                                               x"
		FinSegun
...
Funcion combate (enemigo,pikmin,hp_1,hp_2,ene_1,ene_2,nom_enemigo,nom_pikmin,pocion_vida_chica,pocion_vida_mediana,pocion_vida_grande,antidoto,proteccion)
		...
		para a = 1 Hasta 2 Con Paso 1 Hacer
			...
			Segun turno Hacer
				0:
					...
					Escribir "xx                                                                                                                                             xx"
					Escribir "xx                                                                                                                                             xx"
					Escribir "xx       Turno del enemigo                                                                                                                     xx"
					Escribir "xx                                                                                                                                             xx"
					Escribir "xx                                                                                                                                             xx"
					Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
					Esperar 2 Segundos
				...
				1:
					Borrar Pantalla
					accion = interfaz_principal (pikmin,enemigo,hp_1,hp_2,ene_1,ene_2)
					segun accion Hacer
						1:  // Opcion Lucha
							Borrar Pantalla
							interfaz_pikmin(enemigo,hp_1,hp_2,ene_1,ene_2)
							...
							FinSegun
						2:
							objeto = mochila(pocion_vida_chica,pocion_vida_mediana,pocion_vida_grande,antidoto,proteccion)
							Segun objeto Hacer
								0:
									a = a - 1
									turno_siguiente = 1
...
Algoritmo pruebas
	...
	combate(enemigo,pikmin,hp_1,hp_2,ene_1,ene_2,nombres_pikmin[enemigo],nombres_pikmin[pikmin],pocion_vida_chica,pocion_vida_mediana,pocion_vida_grande,antidoto,proteccion) //Combate en bucle
FinAlgoritmo
