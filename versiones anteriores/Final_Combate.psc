...
Funcion dio = critico (habilidad Por Referencia,enemigo,pikmin,hp_1,hp_2,ene_1,ene_2)
	prob_crit = Aleatorio(0,100)
	Si prob_crit >= 0 y prob_crit <= 10 Entonces
		dio = 1
...
Funcion final_dialogo (resultado,nom_enemigo,nom_pikmin)
	...
	FinSegun
FinFuncion
// Funcion pantalla vacia
funcion vacio (ene_1,dato)
	segun dato Hacer
		0:
			Escribir "x                                                                                                                                               x"
			Escribir "x                                                                                                                                               x"
		...
		0:
			...
			Segun pikmin Hacer
				1:  // Taigre aliado
					...
					Escribir "x               \|(X)><(X)|/\     /./                                                       oooooooooooooooooooooooooooooooooooooooooooo        x"
					Escribir "x                \________/..\   /./                                                        xx  Taigre                                xx        x"
					Escribir "x                 /.__..__....\_/./                                                         xx                      HP: 0 /100        xx        x"
					si ene_1 >= 10 Entonces
						Escribir "x                /_/ /_/ /.___..\/                                                          xx  ENERGIA: " ene_1 "/50                        xx        x"
					SiNo
						Escribir "x                /_/ /_/ /.___..\/                                                          xx  ENERGIA: " ene_1 "/50                         xx        x"
		...
		1:
			...
			Segun enemigo Hacer
				...
				6:	// Pescador
					...
					Escribir "x           oooooooooooooooooooooooooooooooooooooooooooo                                                  /        /     )                      x"
					Escribir "x                                                                                                        |    O    |    _¿                      x"
					Escribir "x                                                                                             sssssssssss|sssssssss|sssssssssssss               x"
					Escribir "x                                                                                             sssssssssss\sssssssss/sssssssssssss               x"
					Escribir "x                                                                                             ssssssssssss\sssssss/ssssssssssssss               x"
					Escribir "x                                                                                                                                               x"
				7:	// Dolarcium
					Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
					Escribir "x                                                                                                                                               x"
				...
				8:	// Grandalf
					...
					Escribir "x                                                                                             ### # # #                                         x"
					Escribir "x           oooooooooooooooooooooooooooooooooooooooooooo                                     # ### ###   _ _                                    x"
					Escribir "x           ll  Grandalf                              ll                                      #### #    (X(X \                                  x"
					Escribir "x           ll                      HP: 0 /100        ll                                       ######   /     \                                 x"
					si ene_2 >= 10 Entonces
						Escribir "x           ll  ENERGIA: " ene_2 "/50                        ll                                       _###__  (__     \                                x"
					SiNo
				...
				10:	
					...
					Escribir "x           ll                      HP: 0 /100        ll                         ~                      ~           *                           x"
					si ene_2 >= 10 Entonces
						Escribir "x           ll  ENERGIA: " ene_2 "/50                        ll          *       ~         X        ~           X         ~                            x"
					SiNo
						Escribir "x           ll  ENERGIA: " ene_2 "/50                         ll           *      ~                   ~                     ~                           x"
					FinSi
					Escribir "x           oooooooooooooooooooooooooooooooooooooooooooo                                             ~                      ~                   x"
				...
				11:	// Indo-mito	
					...
					Escribir "x                                                                                                                 / XX /                        x"
					Escribir "x           oooooooooooooooooooooooooooooooooooooooooooo                                              /|/|       / XX /                         x"
					Escribir "x           ll  Indo-mito                             ll                                             |x  X|     / XX /                          x"
					Escribir "x           ll                      HP: 0 /100        ll                                           __( uu )__  / XX /                           x"
					si ene_2 >= 10 Entonces
						Escribir "x           ll  ENERGIA: " ene_2 "/50                        ll                                          / /|_  _| \ /_XX_/                            x"
					SiNo
						Escribir "x           ll  ENERGIA: " ene_2 "/50                         ll                                          / /|_  _| \ /_XX_/                            x"
				...
				12:	// El parxa
					...
					Escribir "x                                                                                                                                               x"
					Escribir "x                                                                                                    iiiiiiiiii                                 x"
					Escribir "x           oooooooooooooooooooooooooooooooooooooooooooo                                 /\\        ii/  <X>  \i                                x"
					Escribir "x           ll  El parxa                              ll                                /  \\      iii|<X> <X>|ii                               x"
					Escribir "x           ll                      HP: 0 /100        ll                               /  / \\    ii¿i\   |   /iii                              x"
					si ene_2 >= 10 Entonces
						Escribir "x           ll  ENERGIA: " ene_2 "/50                        ll                              /  /   \\  ii¿iii\_|_|_/iiii                              x"
					SiNo
						Escribir "x           ll  ENERGIA: " ene_2 "/50                         ll                              /  /   \\  ii¿iii\_|_|_/iiii                              x"
...
Funcion calculo_enemigo(elemento,pikmin,enemigo,atq,esp_atq,hp_1 Por Referencia,def,esp_def,habilidades_name,dmg,elemento_habilidad,precision_habilidad,hp_2,ene_1,ene_2 Por Referencia,variable_IA,energia)
	...
	si evasion == 1 Entonces
		...
		dio = critico(backup_dano[habilidad_usada],enemigo,pikmin,hp_1,hp_2,ene_1,ene_2)
		arreglo_de_defensa(backup_dano[habilidad_usada],def,esp_def,categoria)
		hp_1 = redon(hp_1 - backup_dano[habilidad_usada])
		ene_2 = ene_2 - energia[habilidad_usada]
	SiNo 
			hab_usada(pikmin,enemigo,hp_1,hp_2,ene_1,ene_2,habilidades_name[habilidad_usada],0)
			Borrar Pantalla
			animacion_atacante(enemigo,hp_1,hp_2,ene_1,ene_2)
...
FinFuncion
// Funcion asigna vida
funcion stats (hp_1 Por Referencia,hp_2 Por Referencia,hp_3 Por Referencia,ene_1 Por Referencia,ene_2 Por Referencia)
	hp_1 = 100  
	hp_2 = 100  
	hp_3 = 100
	ene_1 = 50
...
Funcion combate(enemigo,pikmin,pikmin_2,hp_1 Por Referencia,hp_2 Por Referencia,hp_3 Por Referencia,ene_1 Por Referencia,ene_2 Por Referencia,nom_pikmin,consumibles,nom_consumibles,tipo_interfaz)
	Dimension esp_atq[12],atq[12],def[12],esp_def[12],rapidez[12],elemento[12]
	Dimension dmg[8],habilidades_name[8],elemento_habilidad[8],precision_habilidad[8],objetivo[4],energia[8]
	...
	//	Normal 	= 6
	// Estadisticas:
	esp_atq[1]= 4; 	atq[1]= 5; 	def[1]= 3; esp_def[1]= 	3; rapidez[1]= 8; elemento[1] = 6; // Taigre
	esp_atq[2]= 6; 	atq[2]= 4; 	def[2]= 5; esp_def[2]= 	4; rapidez[2]= 6; elemento[2] = 1; // Bulpaul
	esp_atq[3]= 5; 	atq[3]= 4; 	def[3]= 3; esp_def[3]= 	3; rapidez[3]= 7; elemento[3] = 3; // Bajielim 
	esp_atq[4]= 2; 	atq[4]= 8; 	def[4]= 4; esp_def[4]= 	1; rapidez[4]= 4; elemento[4] = 4; // Samael
	esp_atq[5]= 4; 	atq[5]= 5; 	def[5]= 3; esp_def[5]= 	3; rapidez[5]= 8; elemento[5] = 6; // Taigre
	esp_atq[6]= 6; 	atq[6]= 3; 	def[6]= 4; esp_def[6]= 	4; rapidez[6]= 5; elemento[6] = 3; // Pescador
	esp_atq[7]= 3; 	atq[7]= 6; 	def[7]= 5; esp_def[7]= 	5; rapidez[7]= 3; elemento[7] = 5; // Dolarcium
	esp_atq[8]= 8; 	atq[8]= 2; 	def[8]= 3; esp_def[8]= 	3; rapidez[8]= 3; elemento[8] = 6; // Grandalf
	esp_atq[9]= 7; 	atq[9]= 5; 	def[9]= 4; esp_def[9]= 	4; rapidez[9]= 2; elemento[9] = 2; // TAhiti
	esp_atq[10]=7; 	atq[10]=1;	def[10]=2; esp_def[10]= 2; rapidez[10]=6; elemento[10] =3; // Ebun
	esp_atq[11]=1; 	atq[11]=10;	def[11]=3; esp_def[11]= 3; rapidez[11]=5; elemento[11] =5; // Indo-Mito
	esp_atq[12]=7; 	atq[12]=5; 	def[12]=4; esp_def[12]= 4; rapidez[12]=4; elemento[12] =5; // Parxa
	num_ref = 15
	...
	segun enemigo hacer
		5:
			// Habilidades Taigre:
			habilidades_name[5] = "Garra acero"
			palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
			dmg[5] = 20
			elemento_habilidad[5] = 5
			precision_habilidad[5] = 8
			energia[5]= 6
			
			habilidades_name[6] = "Ataque rapido"
			palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
			dmg[6] = 10
			elemento_habilidad[6] = 6
			precision_habilidad[6] = 10
			energia[6]= 4
			
			habilidades_name[7] = "Depredar"
			palabra_con_espacios(habilidades_name[7],num_ref,habilidad_enemiga_3)
			dmg[7] = 30
			elemento_habilidad[7] = 6
			precision_habilidad[7] = 5
			energia[7]= 8
			
			habilidades_name[8] = "Malicioso"
			palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
			dmg[8] = 15
			elemento_habilidad[8] = 6
			precision_habilidad[8] = 8
			energia[8]= 5
		6:
			// Habilidades Pescador:
            habilidades_name[5] = "Anzuelo"
            palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
            dmg[5] = 15
            elemento_habilidad[5] = 5
            precision_habilidad[5] = 9
            energia[5] = 5
			
            habilidades_name[6] = "Mojar"
            palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
            dmg[6] = 10
            elemento_habilidad[6] = 3
            precision_habilidad[6] = 8
            energia[6] = 8
			
            habilidades_name[7] = "Hundir"
            palabra_con_espacios(habilidades_name[7],num_ref,habilidad_enemiga_3)
            dmg[7] = 20
            elemento_habilidad[7] = 3
            precision_habilidad[7] = 6
            energia[7] = 8
			
            habilidades_name[8] = "puño odio"
            palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
            dmg[8] = 15
            elemento_habilidad[8] = 6
            precision_habilidad[8] = 7
            energia[8] = 7
		7:
            // Habilidades Dolarcium:
            habilidades_name[5] = "Subir el dolar"
            palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
            dmg[5] = 10
            elemento_habilidad[5] = 5
            ...
            habilidades_name[6] = "Tirar billetes"
            palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
            dmg[6] = 20
            elemento_habilidad[6] = 1
            precision_habilidad[6] = 7
            energia[6]=8
			
            habilidades_name[7] = "Tirar monedas"
            palabra_con_espacios(habilidades_name[7],num_ref,habilidad_enemiga_3)
            dmg[7] = 21
            elemento_habilidad[7] = 5
            precision_habilidad[7] = 7
            energia[7]=7
			
            habilidades_name[8] = "!ALERTA! !ALERTA!"
            palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
            dmg[8] = 23
            elemento_habilidad[8] = 2
            precision_habilidad[8] = 6
            energia[8]=8
		8:
			// Habilidades Grandalf:
            habilidades_name[5] = "Zazasound"
            palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
            dmg[5] =24
            elemento_habilidad[5] = 1
            precision_habilidad[5] = 5
            energia[5] = 6
			
            habilidades_name[6] = "Pipazo"
            palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
            dmg[6] = 15
            elemento_habilidad[6] = 6
            precision_habilidad[6] = 8
            ...
            habilidades_name[8] = "Lenguetazo"
            palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
            dmg[8] = 17
            elemento_habilidad[8] = 3
            precision_habilidad[8] = 8
            energia[8] = 6
		9:
			// Habilidades TAhiti:
            habilidades_name[5] = "Vulcano"
            palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
            dmg[5] = 25
            elemento_habilidad[5] = 2
            precision_habilidad[5] = 6
            energia[5]=8
			
            habilidades_name[6] = "Erupcion"
            palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
            dmg[6] = 18
            ...
            habilidades_name[7] = "Holocausto burguer"
            palabra_con_espacios(habilidades_name[7],num_ref,habilidad_enemiga_3)
            dmg[7] = 30
            ...
            habilidades_name[8] = "Choque tectonico"
            palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
            dmg[8] = 15
            elemento_habilidad[8] = 6
		...
		10:
			// Habilidades Ebun:
            habilidades_name[5] = "Llorar"
            palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
            dmg[5] = 20
            elemento_habilidad[5] = 3
            precision_habilidad[5] = 5
            energia[5] = 5
			
            habilidades_name[6] = "Lluvia"
            palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
            dmg[6] = 16
            elemento_habilidad[6] = 3
            precision_habilidad[6] = 8
            ...
            habilidades_name[8] = "Puñonublar"
            palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
            dmg[8] = 20
            elemento_habilidad[8] = 4
            precision_habilidad[8] = 7
            energia[8] = 5
		11:
			// Habilidades Indo-Mito:
            habilidades_name[5] = "CLANK"
            palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
            dmg[5] = 20
            elemento_habilidad[5] = 5
            precision_habilidad[5] = 7
            energia[5] = 8
			
            habilidades_name[6] = "Puño callado"
            palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
            dmg[6] = 18
            elemento_habilidad[6] = 4
            precision_habilidad[6] = 7
            energia[6] = 6
			
            habilidades_name[7] = "Peso muerto"
            palabra_con_espacios(habilidades_name[7],num_ref,habilidad_enemiga_3)
            dmg[7] = 17
            elemento_habilidad[7] = 5
            precision_habilidad[7] = 5
            ...
            habilidades_name[8] = "Luchando"
            palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
            dmg[8] = 21
            elemento_habilidad[8] = 4
            precision_habilidad[8] = 5
            energia[8] = 8
		12:
			// Habilidades Parxa:
            habilidades_name[5] = "MATAR!"
            palabra_con_espacios(habilidades_name[5],num_ref,habilidad_enemiga_1)
            dmg[5] = 25
            elemento_habilidad[5] = 6
            precision_habilidad[5] = 5
            energia[5] = 5
			
            habilidades_name[6] = "Decapitar"
            palabra_con_espacios(habilidades_name[6],num_ref,habilidad_enemiga_2)
            dmg[6] = 25
            elemento_habilidad[6] = 5
            precision_habilidad[6] = 7
            energia[6] = 8
			
            habilidades_name[7] = "Rasgar"
            palabra_con_espacios(habilidades_name[7],num_ref,habilidad_enemiga_3)
            dmg[7] = 15
            elemento_habilidad[7] = 5
            precision_habilidad[7] = 8
            energia[7] = 7
			
            habilidades_name[8] = "Guadaña"
            palabra_con_espacios(habilidades_name[8],num_ref,habilidad_enemiga_4)
            dmg[8] = 22
            elemento_habilidad[8] = 5
            precision_habilidad[8] = 7
            energia[8] = 7
	FinSegun
	Repetir
		...
		segun pikmin hacer
			...
			2:
				...
				dmg[2] = 15
				elemento_habilidad[2] = 6
				precision_habilidad[2] = 9
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[2] = 0
				energia[2]= 6
				
				habilidades_name[3] = "Semillazo"
				palabra_con_espacios(habilidades_name[3],num_ref,habilidad_mia_3)
				dmg[3] = 11
				...
				precision_habilidad[4] = 7 
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[4] = 0
				energia[4] = 8
			3:
				// Habilidades Bajielim:
				habilidades_name[1] = "Burbujas"
				palabra_con_espacios(habilidades_name[1],num_ref,habilidad_mia_1)
				dmg[1] = 10
				elemento_habilidad[1] = 3
				precision_habilidad[1] = 10
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[1] = 0
				energia[1]= 4
				
				habilidades_name[2] = "Cabeza agua"
				palabra_con_espacios(habilidades_name[2],num_ref,habilidad_mia_2)
				dmg[2] = 28
				elemento_habilidad[2] = 3
				precision_habilidad[2] = 5
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[2] = 0
				energia[2]= 6
				
				habilidades_name[3] = "Tritu aracion"
				palabra_con_espacios(habilidades_name[3],num_ref,habilidad_mia_3)
				dmg[3] = 30
				elemento_habilidad[3] = 6
				precision_habilidad[3] = 6
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[3] = 0
				energia[3]= 8
				
				habilidades_name[4] = "Nadar, que ver"
				palabra_con_espacios(habilidades_name[4],num_ref,habilidad_mia_4)
				dmg[4] = 18
				elemento_habilidad[4] = 3
				precision_habilidad[4] = 7
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[4] = 0
				energia[4]= 6
			4:
				// Habilidades Samael:
				habilidades_name[1] = "Puño trinidad"
				palabra_con_espacios(habilidades_name[1],num_ref,habilidad_mia_1)
				dmg[1] = 10
				elemento_habilidad[1] = 4
				precision_habilidad[1] = 10
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[1] = 0
				energia[4] = 4
				
				habilidades_name[2] = "Purificador"
				palabra_con_espacios(habilidades_name[2],num_ref,habilidad_mia_2)
				dmg[2] = 15
				elemento_habilidad[2] = 2
				precision_habilidad[2] = 7
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[2] = 0
				energia[4]= 6
				
				habilidades_name[3] = "Hiroshima"
				palabra_con_espacios(habilidades_name[3],num_ref,habilidad_mia_3)
				dmg[3] = 45
				elemento_habilidad[3] = 4
				precision_habilidad[3] = 5
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[3] = 0
				energia[4] = 8
				
				habilidades_name[4] = "Mirar mal"
				palabra_con_espacios(habilidades_name[4],num_ref,habilidad_mia_4)
				dmg[4] = 20
				elemento_habilidad[4] = 4
				precision_habilidad[4] = 7
				// objetivo 0 = Enemigo / objetivo 1 = Uno mismo
				objetivo[4] = 0
				energia[4] = 6
					...
					si hp_2 >= 1 Entonces
						...
						si hp_2 <= 50 y uso_enemigo == falso Entonces
							...
							si ia_probabilidad >= 4 y ia_probabilidad <= 10 y uso_enemigo == falso Entonces
								calculo_enemigo(elemento[pikmin],pikmin,enemigo,atq[enemigo],esp_atq[enemigo],hp_1,def[pikmin],esp_def[pikmin],habilidades_name,dmg,elemento_habilidad,precision_habilidad,hp_2,ene_1,ene_2,variable_IA,energia)
							FinSi
						FinSi
												...
												Segun ataque Hacer
													1:
														si ene_1 >= energia[1] Entonces
															...
															eficasia = valor_de_ataque_aliado(valor_dano,elemento_habilidad[ataque],elemento[enemigo],variable_IA[1])
															interfaz_eficasia(enemigo,pikmin,hp_1,hp_2,ene_1,ene_2,eficasia,1)
															dio = critico(valor_dano,enemigo,pikmin,hp_1,hp_2,ene_1,ene_2)
															arreglo_de_defensa(valor_dano,def[enemigo],esp_def[enemigo],categoria)
															ene_1 = ene_1 - energia[ataque]
															hp_2 = redon(hp_2 - valor_dano)
														SiNo si ene_1 < energia[1] Entonces
																Borrar Pantalla
																interfaz_pikmin(enemigo,hp_1,hp_2,ene_1,ene_2)
																interfaz_pikmin(pikmin,hp_1,hp_2,ene_1,ene_2)
																Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
																Escribir "xx                                                                                                                                             xx"
																Escribir "xx                                                                                                                                             xx"
																Escribir "xx       Energia insuficiente                                                                                                                  xx"
																Escribir "xx                                                                                                                                             xx"
																Escribir "xx                                                                                                                                             xx"
																Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
																Esperar 2 Segundos
																...
																Escribir "xx                                                                                                                                             xx"
																Escribir "xx                                                                                                                                             xx"
																Escribir "xx       1. Pasar turno / 0. Volver al menu?                                                                                                   xx"
																Escribir "xx                                                                                                                                             xx"
																Escribir "xx                                                                                                                                             xx"
																Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
																leer decision
													...
													2:
														si ene_1 >= energia[2] Entonces
															...
															ene_1 = ene_1 - energia[ataque]
															hp_2 = redon(hp_2 - valor_dano)	
														SiNo si ene_1 < energia[2] Entonces
																Borrar Pantalla
																interfaz_pikmin(enemigo,hp_1,hp_2,ene_1,ene_2)
																interfaz_pikmin(pikmin,hp_1,hp_2,ene_1,ene_2)
																Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
													...
													3:
														si ene_1 >= energia[3] Entonces
															...
															ene_1 = ene_1 - energia[ataque]
															hp_2 = redon(hp_2 - valor_dano)
															si pikmin == 4 y ataque == 3 y hp_1 <= 30 Entonces
																hp_1 = 1 
															SiNo si pikmin == 4 y ataque == 3 y hp_1 >= 31 Entonces
																	hp_1 = hp_1 - 30
																FinSi
															FinSi
														SiNo si ene_1 < energia[3] Entonces
																Borrar Pantalla
																interfaz_pikmin(enemigo,hp_1,hp_2,ene_1,ene_2)
																interfaz_pikmin(pikmin,hp_1,hp_2,ene_1,ene_2)
																Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
													...
													4:
														si ene_1 >= energia[4] Entonces
															...
															ene_1 = ene_1 - energia[ataque]
															hp_2 = redon(hp_2 - valor_dano)
															si pikmin == 2 y ataque == 4 y hp_1 <= 80 y dio == 1 Entonces
																hp_1 = hp_1 + 20
															SiNo si pikmin == 2 y ataque == 4 y hp_1 <= 90 Entonces
																	hp_1 = hp_1 + 10
																FinSi
															FinSi
														SiNo si ene_1 < energia[4] Entonces
																Borrar Pantalla
																interfaz_pikmin(enemigo,hp_1,hp_2,ene_1,ene_2)
																interfaz_pikmin(pikmin,hp_1,hp_2,ene_1,ene_2)
																Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
...
Algoritmo pruebas
	...
	definir hp_1,hp_2,hp_3,ene_1,ene_2 como entero
	stats(hp_1,hp_2,hp_3,ene_1,ene_2)
	// Asignacion de consumibles
	...
	enemigo = 10 // El del enemigo (5,6,7,8,9,10,11,12)
