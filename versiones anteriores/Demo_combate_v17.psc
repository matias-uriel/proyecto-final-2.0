...
Funcion final (pikmin,enemigo,hp_1,hp_2,ene_1,ene_2,resultado,nom_enemigo,nom_pikmin)
	...
	segun resultado Hacer
		0:
			...
			FinPara
			Escribir " ha finalizado, Has ganado                                                                                xx"
			Escribir "xx                                                                                                                                             xx"
			Escribir "xx                                                                                                                                             xx"
			Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
			Esperar tecla
		1:
			...
			FinPara
			Escribir " ha caido derrotado, Perdiste                                                      xx"
			Escribir "xx                                                                                                                                             xx"
			Escribir "xx                                                                                                                                             xx"
			Escribir "oxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxooxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxo"
			Esperar tecla
...
Funcion combate (enemigo,pikmin,pikmin_2,hp_1,hp_2,hp_3,ene_1,ene_2,nom_enemigo,nom_pikmin,nom_pikmin2,pocion_vida_chica,pocion_vida_mediana,pocion_vida_grande,pocion_energia_chica,pocion_energia_grande)
				...
				1:
					...
					segun accion Hacer
						...
						3:// cambiar pikmin
							...
							FinSegun
						4:
							volver = detalles_habilidades(pikmin,nom_pikmin,elemento[pikmin],esp_atq[pikmin],atq[pikmin],def[pikmin],esp_def[pikmin],rapidez[pikmin],habilidades_aliado_name,dmg_aliado,elemento_habilidad,precision_habilidad,objetivo)
	...
	sino si (hp_2 <= 0) Entonces
		...
		FinSi
	FinSi
	final(pikmin,enemigo,hp_1,hp_2,ene_1,ene_2,resultado,nom_enemigo,nom_pikmin)
FinFuncion
// Programa principal
Algoritmo pruebas
